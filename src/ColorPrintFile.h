...
#define WHITE_PRINT_LOG(LOG, exp, ...)  fprintf(LOG, LIGHTWHITE_SYMBOLS exp DEFAULT_COLOR, __VA_ARGS__)

#define RED_PRINT(exp)                   printf(RED_SYMBOLS exp DEFAULT_COLOR)
#define RED_PRINT_LOG(LOG, exp, ...)    fprintf(LOG, RED_SYMBOLS exp DEFAULT_COLOR, __VA_ARGS__)

#define YELLOW_PRINT(exp)                printf(YELLOW_SYMBOLS exp DEFAULT_COLOR)
#define YELLOW_PRINT_LOG(LOG, exp, ...) fprintf(LOG, YELLOW_SYMBOLS exp DEFAULT_COLOR, __VA_ARGS__)

#define CYAN_PRINT(exp)                  printf(CYAN_SYMBOLS exp DEFAULT_COLOR) 
#define CYAN_PRINT_LOG(LOG, exp, ...)   fprintf(LOG, CYAN_SYMBOLS exp DEFAULT_COLOR, __VA_ARGS__)

#define GREEN_PRINT(exp)                 printf(GREEN_SYMBOLS exp DEFAULT_COLOR)
#define GREEN_PRINT_LOG(LOG, exp, ...)  fprintf(LOG, GREEN_SYMBOLS exp DEFAULT_COLOR, __VA_ARGS__)
